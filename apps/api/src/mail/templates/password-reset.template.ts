...
export function passwordResetTemplate({ resetUrl, expiresInLabel }: PasswordResetTemplateInput) {
  const subject = 'Reset your BeaconVie password';

  const text = [
    'We received a request to reset your BeaconVie password.',
            ...
            <tr>
              <td>
                ...
                <p style="color:#B7AFC9;font-size:16px;line-height:1.5;margin:0 0 24px;">
                  We received a request to reset your BeaconVie password. Use the button below to choose a new one.
                </p>
