...
export const metadata: Metadata = buildMetadata({
  title: 'Giới thiệu',
  description: 'Mệnh Vi kết hợp Tử Vi, Tarot, chiêm tinh và thần số học trong một trải nghiệm hiện đại, riêng tư.',
  path: '/about',
});
    ...
    <div className="mx-auto max-w-content px-4 py-16 desktop:px-8">
      <MvPage>
        <MvPageHeader
          ...
          description="Mệnh Vi kết hợp Tử Vi, Tarot, Bản đồ sao và Thần số học trong một trải nghiệm riêng tư, có kiểm soát và không dùng dữ liệu giả để tạo cảm giác cá nhân hóa."
        />
