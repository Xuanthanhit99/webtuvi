...
export function RememberThisButton({ conversationId, messageId, content, createdAt }: RememberThisButtonProps) {
  ...
  return (
    <>
      ...
      <Dialog open={open} onClose={() => setOpen(false)} title="Remember this?" description="Mệnh Vi will save this as a memory you can view, edit the title of, or delete anytime.">
