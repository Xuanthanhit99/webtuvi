...
export function welcomeTemplate({ displayName, appUrl }: WelcomeTemplateInput) {
  const subject = 'Chào mừng bạn đến với Mệnh Vi';

  const text = [
    `Chào ${displayName},`,
    'Tài khoản Mệnh Vi của bạn đã sẵn sàng.',
    `Tiếp tục tại đây: ${appUrl}`,
  ].join('\n\n');
          ...
          <table role="presentation" width="100%" style="max-width:480px;background-color:#1F1C36;border-radius:20px;padding:32px;" cellpadding="0" cellspacing="0">
            <tr>
              <td>
                ...
                <h1 style="color:#F1ECE4;font-size:22px;line-height:1.3;margin:0 0 16px;">Chào ${displayName},</h1>
                <p style="color:#B7AFC9;font-size:16px;line-height:1.5;margin:0 0 24px;">
                  Tài khoản của bạn đã sẵn sàng. Quay lại bất cứ khi nào bạn muốn tiếp tục cuộc trò chuyện.
                </p>
