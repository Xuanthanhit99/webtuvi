...
export function notificationEmailTemplate({ title, body, ctaLabel, ctaUrl }: NotificationEmailTemplateInput) {
  ...
  const text = [body, `${ctaLabel}: ${ctaUrl}`, 'Quản lý các email Mệnh Vi gửi cho bạn tại Cài đặt > Thông báo.'].join('\n\n');
            ...
            <tr>
              <td>
                ...
                <p style="color:#B7AFC9;font-size:14px;line-height:1.5;margin:24px 0 0;">
                  Quản lý các email Mệnh Vi gửi cho bạn tại Cài đặt &gt; Thông báo.
                </p>
              </td>
            </tr>
          </table>
