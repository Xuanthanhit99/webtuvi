...
export function Dialog({ open, onClose, title, description, children, variant = 'default' }: DialogProps) {
  ...
  return (
    <dialog
      ...
      className="w-[min(92vw,44rem)] rounded-lg border border-[rgba(213,173,98,0.16)] bg-surface-raised p-6 text-text-primary shadow-[0_24px_80px_rgba(0,0,0,0.42)] backdrop:bg-canvas/75"
    >
