...
export function ConflictsSection() {
  ...
  if (conflicts.length === 0) {
    return <EmptyState title="No conflicts found." description="BeaconVie flags memories that seem to contradict each other, like an old address next to a new one." />;
  }
