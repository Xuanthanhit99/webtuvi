...
// Sprint 14 (Ambiguity Cleanup): local not-found boundary for the archived `/menh-vi/*` segment —
// colocated (rather than relying solely on the root boundary) so Next.js correctly returns an
// HTTP 404 for every route under here, not just the matching UI. See app/menh-vi/layout.tsx.
export default function MenhViNotFound() {
  return (
